...
import type { Country, Filters, LangMode } from './types';

export const DEFAULT_FILTERS: Filters = { lang: '', langMode: 'official', continents: [], includeSpecial: true };
...
export function isFiltered(f: Filters): boolean {
  return Boolean(f.lang) || f.continents.length > 0 || !f.includeSpecial;
}
